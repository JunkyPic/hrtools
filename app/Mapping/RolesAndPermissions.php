...
class RolesAndPermissions
{
    ...
    const PERMISSION_ADD_DEFAULT_MESSAGE = 'add test default message';
    const PERMISSION_EDIT_DEFAULT_MESSAGE = 'edit test default message';
    //review
    ...
    private $permissions = [
        ...
        self::PERMISSION_ADD_DEFAULT_MESSAGE,
        self::PERMISSION_EDIT_DEFAULT_MESSAGE,
    ];
